...
private:
	...
	uint8_t spec_eos_, spec_gain_, spec_trg_, spec_clk_, spec_st_, ext_trg_;
...
public:
    ...
    C12666MA(uint8_t spec_trg, uint8_t spec_eos, uint8_t spec_gain, uint8_t spec_clk, uint8_t spec_st,
    ...
    // Set integration time in microseconds (if not within 2ms...10s boundary
    ...
    // Attribute getters
    gain_t getGain()               { return (gain_t)gain_; }

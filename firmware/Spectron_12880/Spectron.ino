...
void setup()
{
    ...
    initSuccess = initSuccess && Particle.variable("spSaturationVoltage", specSatVoltage);
    ...
    initSuccess = initSuccess && Particle.function("spSetSaturationVoltage",  specSetSaturationVoltage);
